...
# import optimize_model_hyperparameters as optimize_model_hyperparameters
...
##################
# this may create a conflict with np.obv
##################
# def obv(data):
...
# def fetch_financial_data(ticker="SPY", start_year=1993, end_year=None, interval='1d'):
#     """
